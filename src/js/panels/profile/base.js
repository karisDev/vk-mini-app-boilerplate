...
import { Icon28SchoolOutline, Icon28AddOutline } from "@vkontakte/icons";
  ...
  return (
    <>
      ...
      <Group>
        <Gradient
          className={
            mainStorage.isDesktop ? "ProfileUserWeb" : "ProfileUserMobile"
          }
        >
          <Avatar size={96} src={mainStorage.infoUser.photo_200} />

          <Title className="NameUser" level="2" weight="medium">
            {mainStorage.infoUser.name}
          </Title>

          <Text className="SubheaderUser">Какой-нибудь статус человека...</Text>
        ...
        <SimpleCell before={<Icon28SchoolOutline />} description="Екатеринбург">
          Школа №180
        </SimpleCell>
